...
import static android.opengl.GLES20.GL_MAX_VIEWPORT_DIMS;
...
public class RGBProgram extends ShaderProgram {
    ...
    public RGBProgram(Context context, int width, int height,float scaleX,float scaleY) {
    ...
    public void setUniforms(byte[] data, int rotateDegrees) {
        setUniforms(data, mScaleX, mScaleY, rotateDegrees);
    }
